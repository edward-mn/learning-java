...
public class TClube implements IEsporte,IModalidade {
	...
	private final static String DescricaoErro = "Não foi possivel Salva Desculpe";
	...
	private void PedeDados() {
		...
		System.out.println("Digite um Patrocínio dessa Modalidade: ");
		this.setNomePatrocinio(Leitor.nextLine());
		
		System.out.println("Digite um Esporte: ");
		this.setNomeEsporte(Leitor.nextLine());
		
		System.out.println("Digite o nome de um Campeão desse Esporte: ");
